            ...
            with tf.variable_scope("g_net"):
                self.generator_template = \
                    (pt.template("input").
                     ...
                     custom_fully_connected(image_size / 32 * image_size / 32 * 8192).
                     fc_batch_norm().
                     apply(tf.nn.relu).
                     reshape([-1, image_size / 32, image_size / 32, 8192]).

                     #custom_deconv2d([0, image_size / 16, image_size / 16, 256], k_h=4, k_w=4).
                     #conv_batch_norm().
                     #apply(tf.nn.relu).
                     ...
                     custom_deconv2d([0, image_size / 16, image_size / 16, 4096], k_h=4, k_w=4).
                     conv_batch_norm().
                     apply(tf.nn.relu).
